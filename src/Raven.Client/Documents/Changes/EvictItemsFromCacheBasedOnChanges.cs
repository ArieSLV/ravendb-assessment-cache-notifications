...
{
    internal sealed class EvictItemsFromCacheBasedOnChanges : IObserver<DocumentChange>, IObserver<IndexChange>, IObserver<CacheInvalidationChange>, IDisposable
    {
        ...
        {
            if (CacheInvalidationChange.ShouldInvalidateCache(change))
            {
        ...
        public void OnNext(CacheInvalidationChange value)
        {
            Interlocked.Increment(ref _requestExecutor.Cache.Generation);
        }
